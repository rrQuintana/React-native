        ...
        {!User.usuario ? (
          ...
          <>
            <>
              ...
              <Text className="text-3xl font-bold dark:text-white self-center mt-5">
                {User.publicaciones.map((publicacion) => (
                  <View className="flex-row mb-3 justify-center items-center mt-5">
                    <Image
                      ...
                      className="w-20 h-20 rounded-full mr-1 self-center mb-2"
                    />
                    <View className="flex mt-2 w-50">
                      <Text className="font-bold">{publicacion.titulo}</Text>
                      <Text >{publicacion.contenido}</Text>
                      <Text>categoria: {publicacion.categoria}</Text>
